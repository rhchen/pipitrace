...
public class SoftIrqUtil {

	private static final long PACKET_HEADER_MAGIC_NUMBER = 0xc1fc1fc1L;
	
	public static void _write_soft_irq(JsonGenerator g, ArrayList<ImmutableTable<TracePrefix, TracerType, TraceSuffix>> tableList) throws JsonGenerationException, IOException{
		...
		for(int i=0; i<tableList.size(); i++){
			...
			Map<TracePrefix, TraceSuffix> dataMap = columnMap.get(TracerType.SOFT_IRQ);
