 ...
 */
public abstract class LoadHistogram implements ControlListener, PaintListener, KeyListener, MouseListener, MouseTrackListener, IHistogramModelListener {
     ...
     */
    public LoadHistogram(final TmfView view, final Composite parent) {
        fParentView = view;
