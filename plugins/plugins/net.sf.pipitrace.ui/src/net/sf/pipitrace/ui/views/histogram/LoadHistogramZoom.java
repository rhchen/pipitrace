 ...
 * <p>
 */
public class LoadHistogramZoom implements MouseWheelListener {
    ...
    private final LoadHistogram fHistogram;
     ...
     */
    public LoadHistogramZoom(LoadHistogram histogram, Canvas canvas, long start,
            long end) {
    ...
    private static class MouseScrollCounter extends Thread {
         ...
         */
        public MouseScrollCounter(LoadHistogramZoom zoom) {
            fZoom = zoom;
